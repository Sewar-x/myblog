...
| 项目         | 技术                                                         | **前置知识**                                   |
| ------------ | ------------------------------------------------------------ | ---------------------------------------------- |
| Vue3 组件库  | Element-Plus                                                 | Vue3、Element-Plus、TypeScript、Less、样式隔离 |
| Vue2 组件库  | Element-UI                                                   | Vue2、Element、JavaScript                      |
| React 组件库 | Ant Design                                                   | React18、Ant-Design、TypeScript                |
| 组件设计     |                                                              | 组件化设计、Hooks、Mixins                      |
| 组件文档     | VitePress                                                    | VitePress、SSG、iframe、Vue渲染原理            |
| 代码规范     | Eslint、StyleLint、CommitLint                                | lint配置、 VScode 配置                         |
