...
export const buttonVariants = ({buttonProvider, type}) => {
  return cva(
    // 基础样式（所有变体共享）
    'xt-flex xt-items-center xt-justify-center xt-inline-flex '
    'xt-whitespace-nowrap xt-cursor-pointer '
    'xt-transition-[background-color,color,border-color,opacity] '
    'xt-duration-200 xt-ease-in-out xt-outline-none',
    
    {
      // 变体定义
      variants: {
        type: {
          default: 'xt-bg-brand-default xt-text-brand-text ...',
          primary: 'xt-bg-brand-default xt-text-brand-text ...',
          secondary: 'xt-bg-background-default xt-text-text-secondary ...',
          emphasize: 'xt-bg-emphasize-default xt-text-text-inverse ...',
          warning: 'xt-bg-warning-default xt-text-text-inverse ...',
          dashed: 'xt-bg-background-default xt-border-dashed ...',
          text: 'xt-bg-transparent xt-text-foreground ...',
          icon: '!xt-p-0 xt-bg-transparent ...',
          link: 'xt-bg-transparent xt-text-blue-default ...',
        },
        size: {
          xlarge: 'xt-px-200 xt-min-w-[80px] xt-h-xlarge ...',
          large: 'xt-px-4 xt-min-w-[80px] xt-h-large ...',
          medium: 'xt-px-3 xt-min-w-[64px] xt-h-medium ...',
          small: 'xt-px-2 xt-min-w-[49px] xt-h-[28px] ...',
          mini: 'xt-px-[4px] xt-min-w-[40px] xt-h-[24px] ...',
        },
        disabled: {
          true: 'xt-opacity-40 !xt-cursor-not-allowed',
        },
        loading: { true: '' },
        ghost: { true: '' },
        block: { true: 'xt-w-full' },
        // ... 更多变体
      },
      ...
      compoundVariants: [
        ...
        { 
          loading: true, 
          type: 'secondary', 
          className: 'hover:xt-bg-background-default ...' 
        },
        // icon + size 特殊尺寸
        {
          type: 'icon',
          size: 'medium',
          className: 'xt-w-[32px] xt-h-[32px]',
        },
        // primary + ghost 幽灵态
        {
          type: 'primary',
          ghost: true,
          className: 'xt-bg-text-inverse xt-text-text-primary ...',
        },
        // ... 50+ 个组合变体
      ],
...
graph TB
    ...
    subgraph "Alias Tokens (别名)"
        B1[--xt-color-brand-default]
        B2[--xt-color-text-primary]
        B3[--xt-color-stroke-default]
    end
    
    subgraph "Component Tokens (组件)"
        C1[Button: --xt-btn-bg]
        C2[Modal: --xt-modal-z-index]
        C3[Table: --xt-table-border-color]
    end
...
@layer base {
  :root {
    /* ===== 基础色阶（Global Tokens）===== */
    /* 中性色 */
    --xt-neutral-50: #FAFAFA;
    --xt-neutral-100: #F5F5F5;
    --xt-neutral-200: #E5E5E5;
    --xt-neutral-300: #D4D4D4;
    --xt-neutral-400: #A3A3A3;
    --xt-neutral-500: #737373;
    --xt-neutral-600: #525252;
    --xt-neutral-700: #404040;
    --xt-neutral-800: #262626;
    --xt-neutral-900: #171717;
    --xt-neutral-1000: #0A0A0A;
    --xt-neutral-1100: #050505;
    --xt-neutral-1200: #000000;
    ...
    /* ===== 语义化别名（Alias Tokens）===== */
    /* 品牌色 */
    --xt-color-brand-default: var(--xt-neutral-1200);
    --xt-color-brand-hover: var(--xt-neutral-900);
    --xt-color-brand-active: var(--xt-neutral-1100);
    
    /* 文字颜色 */
    --xt-color-text-primary: var(--xt-neutral-1200);
    --xt-color-text-secondary: var(--xt-neutral-1000);
    --xt-color-text-tertiary: var(--xt-neutral-700);
    
    /* 背景色 */
    --xt-color-background-default: var(--xt-neutral-100);
    --xt-color-background-surface: var(--xt-neutral-300);
    --xt-color-background-modal: var(--xt-neutral-100);
    
    /* 描边色 */
    --xt-color-stroke-default: var(--xt-neutral-500);
    --xt-color-stroke-active: var(--xt-neutral-1200);
    
    /* 图标色 */
    --xt-color-icon-info: var(--xt-blue-600);
    --xt-color-icon-success: var(--xt-green-600);
    --xt-color-icon-error: var(--xt-red-600);
  }
}
```
  ...
  shadcnUiTheme,  // Shadcn 默认主题
  {
    ...
    theme: {
      ...
      extend: {
        colors: {
          brand: {
            default: 'var(--xt-color-brand-default)',
            hover: 'var(--xt-color-brand-hover)',
            active: 'var(--xt-color-brand-active)',
          },
          text: {
            primary: 'var(--xt-color-text-primary)',
            secondary: 'var(--xt-color-text-secondary)',
          },
          background: {
            default: 'var(--xt-color-background-default)',
            hover: 'var(--xt-color-background-hover)',
          },
          stroke: {
            default: 'var(--xt-color-stroke-default)',
          },
          // ... 完整的颜色映射
        },
        
        borderRadius: {
          small: 'var(--xt-radius-small)',
          medium: 'var(--xt-radius-medium)',
          large: 'var(--xt-radius-large)',
        },
        
        fontSize: {
          '16-semibold': ['var(--xt-font-16)', { 
            lineHeight: 'var(--xt-lineHeight-22)', 
            fontWeight: 'var(--xt-weight-semibold)' 
          }],
          // ... 其他字号
        },
        
        spacing: {
          100: 'var(--xt-space-100)',  // 8px
          200: 'var(--xt-space-200)',  // 16px
          300: 'var(--xt-space-300)',  // 24px
        },
        
        boxShadow: {
          'light-100': 'var(--xt-elevation-shadow-light-100)',
          'dark-100': 'var(--xt-elevation-shadow-dark-100)',
        },
      },
    },
...
<!-- 组件库 Tailwind（带前缀）-->
<button class="xt-bg-brand-default xt-text-brand-text xt-px-4 xt-py-2 xt-rounded-medium">
```
...
*::after {
  ...
  border-width: 0;
  border-style: solid;
  border-color: var(--xt-color-stroke-default);
}
...
<template>
  <Teleport to="body">
    <div 
      class="xt-fixed xt-inset-0 xt-z-[var(--modal-z-index)]"
...
**现象**：组件库的 `xt-bg-blue-500` 与主应用的 `bg-blue-500` 冲突。
